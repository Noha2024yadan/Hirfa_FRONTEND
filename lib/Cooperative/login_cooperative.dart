...
class Logincooperative extends StatefulWidget {
  ...
  @override
  State<Logincooperative> createState() => _LogincooperativeState();
}

class _LogincooperativeState extends State<Logincooperative> {
  String? email;
  String? password;
                    ...
                    TextButton(
                      onPressed: () {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(
                            builder: (context) => RegisterCooperative(),
                          ),
                        );
                      },
                      child: const Text(
