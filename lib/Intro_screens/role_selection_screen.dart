              ...
              style: ButtonStyle(
                backgroundColor: WidgetStateProperty.resolveWith<Color>((
                  ...
                  if (states.contains(WidgetState.disabled)) {
                    return const Color(0xFFF0E8E2); // disabled background
                  }
                  return const Color(0xFF863a3a); // enabled background
                }),
                foregroundColor: WidgetStateProperty.resolveWith<Color>((
                  Set<WidgetState> states,
                ) {
                  if (states.contains(WidgetState.disabled)) {
                    return const Color(0xC15C4B4B); // disabled text/icon color
                  }
      ...
      child: Container(
        ...
        child: Row(
          children: [
            FaIcon(
              icon,
              color: isSelected ? const Color(0xFF863a3a) : Color(0xC15C4B4B),
              size: 24,
            ),
